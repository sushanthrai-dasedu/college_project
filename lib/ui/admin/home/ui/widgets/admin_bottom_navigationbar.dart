...
class AdminAppBottomNavigation extends StatefulWidget {
  const AdminAppBottomNavigation({super.key, required this.selectedIndex, required this.onTabChange});

  final int selectedIndex;
  final Function(int) onTabChange;

  @override
  State<AdminAppBottomNavigation> createState() => _AdminAppBottomNavigationState();
}
